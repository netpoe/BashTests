	...
	if [[ $COUNT -le $QCOUNT ]]; then
		case $COUNT in
			...
			2 )
				...
				;;
			3 )
				expect_commands "move the entire ~/workspace/config/ directory to the nested-level-1/ directory by using absolute paths on both arguments" "mv /home/codio/workspace/config/ /home/codio/workspace/nested-directories/nested-level-1" "mv /home/codio/workspace/config /home/codio/workspace/nested-directories/nested-level-1" "mv ~/workspace/config/ ~/workspace/nested-directories/nested-level-1" "mv ~/workspace/config ~/workspace/nested-directories/nested-level-1"
				;;
		esac
	else 
		reset_history
